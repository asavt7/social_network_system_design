...
* user_media_files:
  ...
  + original photo size: 3 MB
  + feed photo size: 0.8 MB
  ...
  + Диск на 1 год: 315360000 * 3.8MB ~= 1200TB
...
| user_media_files | 1200 TB  | 60 GB/s  | 60000 |
...
| subsystem        | Capacity, GB | Traffic, MB/s | IOPs  | HDD (by capacity) | HDD (by throughput) | HDD (by iops) | SSD (SATA)  (by capacity) | SSD (SATA) (by throughput) | SSD (SATA)  (by iops) | SSD (nVME)  (by capacity) | SSD (nVME) (by throughput) | SSD (nVME)  (by iops) |
|------------------|--------------|---------------|-------|-------------------|---------------------|---------------|---------------------------|----------------------------|-----------------------|---------------------------|----------------------------|-----------------------|
| posts            | 80           | 15            | 1200  | 3                 | 1                   | 1             | 1                         | 1                          | 1                     | 3                         | 1                          | 1                     |
| user_media       | 160          | 30            | 1200  | 5                 | 2                   | 2             | 2                         | 1                          | 1                     | 6                         | 1                          | 1                     |
| user_media_files | 1200000      | 60000         | 60000 | 37500             | 12000               | 12000         | 12000                     | 2400                       | 1200                  | 40000                     | 400                        | 120                   |
| subscriptions    | 3            | 1             | 8     | 1                 | 1                   | 1             | 1                         | 1                          | 1                     | 1                         | 1                          | 1                     |
| comments         | 1200         | 1             | 840   | 38                | 12                  | 12            | 12                        | 3                          | 2                     | 40                        | 1                          | 1                     |
| reactions        | 1000         | 6             | 2400  | 32                | 10                  | 10            | 10                        | 2                          | 1                     | 34                        | 1                          | 1                     |
| user_feeds       | 100          | 12            | 1200  | 4                 | 1                   | 1             | 1                         | 1                          | 1                     | 4                         | 1                          | 1                     |

[more readable](disk_calculations/Sheet1.html)

### Итоговая оценка

| subsystem                  | Capacity, GB | Traffic, MB/s | IOPs  | HDD, count | SSD (SATA), count | SSD (nVME), count | HDD, price $  | SSD (SATA), price $ | SSD (nVME), price $ |
|----------------------------|--------------|---------------|-------|------------|-------------------|-------------------|---------------|---------------------|---------------------|
| posts                      | 80           | 15            | 1200  | 3          | 1                 | 3                 | $300          | $300                | $1, 500             |
| user_media                 | 160          | 30            | 1200  | 5          | 2                 | 6                 | $500          | $600                | $3, 000             |
| user_media_files           | 1200000      | 60000         | 60000 | 37500      | 12000             | 40000             | $3, 750, 000  | $3, 600, 000        | $20, 000, 000       |
| subscriptions              | 3            | 1             | 8     | 1          | 1                 | 1                 | $100          | $300                | $500                |
| comments                   | 1200         | 1             | 840   | 38         | 12                | 40                | $3, 800       | $3, 600             | $20, 000            |
| reactions                  | 1000         | 6             | 2400  | 32         | 10                | 34                | $3, 200       | $3, 000             | $17, 000            |
| user_feeds                 | 100          | 12            | 1200  | 4          | 1                 | 4                 | $400          | $300                | $2, 000             |
|                            |              |               |       |            |                   |                   |               |                     |                     |
| TOTAL                      |              |               |       | 37583      | 12027             | 40088             | $3, 758, 300  | $3, 608, 100        | $20, 044, 000       |
| TOTAL * Replication Factor |              |               |       | 112749     | 36081             | 120264            | $11, 274, 900 | $10, 824, 300       | $60, 132, 000       |
